...
import { isAllSourcesEnabled } from './sourcePreferences';
import { Article, Topic } from '../types';
import type { FeedSource, PushPreferences } from './types';
...
export function addBlockedTopic(prefs: PushPreferences, topic: Topic): PushPreferences {
...
export function addBlockedSportTag(prefs: PushPreferences, tag: SportTag): PushPreferences {
...
export function addBlockedKeyword(prefs: PushPreferences, keyword: string): PushPreferences {
  const normalized = keyword.trim().toLowerCase();
...
export function normalizeBlockPreferences(prefs: PushPreferences): PushPreferences {
