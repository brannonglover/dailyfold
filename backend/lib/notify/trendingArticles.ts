...
/**
 * Partial port of utils/trendingArticles.ts (lines 1-68) — burst/breaking detection
 * only. Feed-badge helpers (TrendingBadge*, mostTrendingArticle, etc.) are not needed
 * server-side and were not ported.
 */

// copied from utils/feedOrdering.ts:4 — keep in sync
